(function() {
    ...
    require_modules[13] = function(global, module, require) {
        ...
        module.exports = {
            ...
            createStylesheet: function(code, parentElement) {
                ...
                if (parentElement) style.scoped = "scoped";
                if (style.styleSheet) {
    ...
    require_modules[29] = function(global, module, require) {
        ...
        var DataList = view.newClass("DataList", Container, Focusable, {
            ...
            scrollToIndex: function(index) {
                ...
                if (maxY >= range.to) {
                    this.scrollableParent().scroll(xScrollPos, maxY - range.to + (index === this.data().length - 1 ? 100 : 0));
    ...
    require_modules[30] = function(global, module, require) {
        var exports = this;
        var fun = require(7), Observable = require(18).Observable;
    ...
    require_modules[33] = function(global, module, require) {
        var exports = this;
        var fun = require(7), env = require(3), Observable = require(18).Observable;
        var SelectionController = fun.newClass(Observable, {
            ...
            _onkeyrepeat: function(e) {
                ...
                var selection = this._view.selection(), nextIndex = -1;
    ...
    require_modules[34] = function(global, module, require) {
        ...
        "use strict";
        1;
        var fun = require(7), utils = require(4), env = require(3), dom = require(13), view = require(10), build = require(6).build, Pack = require(35).Pack, DataList = require(29).DataList, Mustache = require(19).Mustache, Base = require(15).Base, Container = require(14).Container, evt = require(12);
        ...
        var DataTable = view.newClass("DataTable", Container, {
            ...
            _updateContainerHeight: function() {
                if (!this._dom.clientHeight && !this._dom.clientWidth) {
                    return;
                }
                ...
                if (tableContainerWidth < tableDataWidth) {
                    ...
                    if (scrollChange) {
                        this._scrollContainer.pos(scrolledPos);
                    }
                }
        ...
        fun.delegateProp(DataTable.prototype, [ "filterable", "filterTimeout", "sortable", "hasMenu", "menuOptions", "menu", "menuImage", "title" ], "header");
        ...
        var DataTableFooter = view.newClass("DataTableFooter", Container, {
            template: fun.newProp("template"),
            _template: '<table class="uki-dataTable-footer"><tbody><tr class="uki-dataTable-footer-row">{{#columns}}<td class="uki-dataTable-footer-cell uki-dataTable-col-{{pos}}"><div class="uki-dataTable-footer-wrap"><div class="uki-dataTable-footer-text" name="footer_{{pos}}" style="{{style}}">{{value}}</div></div></td>{{/columns}}</td></tr></tbody></tbody></table>\r\n\r\n',
            _createDom: function(initArgs) {
        ...
        var DataTableAdvancedHeader = view.newClass("DataTableAdvancedHeader", Container, {
            ...
            _createDom: function(initArgs) {
                ...
                this._titleValue = dom.createElement("div", {
                    className: "uki-dataTable-header-title"
                });
                this._titleValue.style.display = "none";
            ...
            _filterStartTimer: function(myTarget) {
                ...
                self._intervalId = setTimeout(function(self, target) {
                    return function() {
                        self._clearFilterInterval();
        ...
        var DataTableList = view.newClass("DataTableList", DataList, {
            ...
            _createDom: function(initArgs) {
                ...
                this._placeholder = dom.createElement("div", {
                    "class": "uki-dataList-placeholder"
                });
                this._placeholder.innerHTML = "&nbsp";
