(function() {
    ...
    require_modules[20] = function(global, module, require) {
        ...
        utils.extend(view, require(21), require(23), require(24), require(25), require(26), require(27), require(28), {
            dataList: utils.extend({}, require(29), require(32), require(30), require(31))
        }, require(33), {
            dataTable: utils.extend({}, require(34))
        });
        module.exports = view;
    };
    ...
    require_modules[24] = function(global, module, require) {
        ...
        fun.delegateProp(NativeControl.prototype, [ "name", "checked", "disabled", "value", "type" ], "_input");
        ...
        require(8).Collection.addProps([ "name", "checked", "disabled", "value", "type", "placeholder", "disabled", "options", "selectedIndex" ]);
    ...
    require_modules[28] = function(global, module, require) {
        var exports = this;
        1;
        var fun = require(7), utils = require(4), dom = require(13), view = require(10), build = require(6).build, Metrics = require(29).Metrics, Selection = require(30).Selection, Pack = require(31).Pack, SelectionController = require(32).SelectionController, Container = require(14).Container, Focusable = require(22).Focusable;
    ...
    require_modules[33] = function(global, module, require) {
        var exports = this;
        1;
        var fun = require(7), utils = require(4), dom = require(13), view = require(10), build = require(6).build, Pack = require(34).Pack, DataList = require(28).DataList, Mustache = require(19).Mustache, Base = require(15).Base, Container = require(14).Container, Focusable = require(22).Focusable;
        ...
        var DataTableHeader = view.newClass("DataTableHeader", Base, {
            template: fun.newProp("template"),
            _template: '<table class="uki-dataTable-header" style="{{style}}"><tbody><tr class="uki-dataTable-header-row">{{#columns}}<td class="uki-dataTable-header-cell {{className}}" style="{{style}}"><div class="uki-dataTable-header-wrap"><div class="uki-dataTable-header-text">{{label}}</div><div class="uki-dataTable-resizer uki-dataTable-resizer_pos-{{pos}}">|</div></div></td>{{/columns}}</tr></table>',
            _createDom: function(initArgs) {
    ...
    require_modules[34] = function(global, module, require) {
        var exports = this;
        var fun = require(7), utils = require(4), dom = require(13), Mustache = require(19).Mustache, Base = require(31).Pack;
