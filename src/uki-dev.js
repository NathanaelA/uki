(function() {
    ...
    require_modules[17] = function(global, module, require) {
        ...
        var addDraggestures = {
            setup: function(el) {
                if (el[mark]) {
                    ...
                    el[mark] = 1;
                    evt.on(el, "mousedown ztouchstart", dragGestureStart);
                }
            },
        ...
        function startGesture(el, e) {
            ...
            evt.on(env.doc, "mousemove scroll ztouchmove", dragGesture);
            evt.on(env.doc, "mouseup dragend ztouchend", dragGestureEnd);
            evt.on(env.doc, "selectstart mousedown ztouchstart", evt.preventDefaultHandler);
        }
    ...
    require_modules[28] = function(global, module, require) {
        ...
        var Menu = view.newClass("Menu", Base, {
            _createDom: function() {
                ...
                this._hasTouch = false, this.on("click", fun.bind(this._click, this));
    ...
    require_modules[34] = function(global, module, require) {
        var exports = this;
        1;
        var fun = require(7), utils = require(4), env = require(3), dom = require(13), view = require(10), build = require(6).build, Pack = require(35).Pack, DataList = require(29).DataList, Mustache = require(19).Mustache, Base = require(15).Base, Container = require(14).Container, evt = require(12), Menu = require(28).Menu;
