(function() {
    ...
    require_modules[28] = function(global, module, require) {
        ...
        var Menu = view.newClass("Menu", Base, {
            _createDom: function() {
                this._dom = dom.createElement("ul", {
                    className: "uki-menu-horizontal uki-textSelectable_off"
                });
    ...
    require_modules[34] = function(global, module, require) {
        ...
        var DataTable = view.newClass("DataTable", Container, {
            ...
            _resizeColumn: function(e) {
                if (typeof e.column.pos === "function") {} else {
        ...
        var DataTableList = view.newClass("DataTableList", DataList, {
            ...
            _columns: [],
            _template: '<table class="uki-dataTable-pack"><tbody>{{#rows}}<tr class="uki-dataList-row uki-dataList-row{{index}} uki-dataTable-row{{^even}} uki-dataList-row_odd{{/even}}">{{#columns}}<td class="uki-dataTable-cell {{className}}" style="{{style}}">{{{value}}}</td>{{/columns}}<td class="uki-dataTable-cell uki-dataTable-spacer"></td></tr>{{/rows}}</tbody></table>',
            _createDom: function(initArgs) {
