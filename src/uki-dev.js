(function() {
    ...
    require_modules[34] = function(global, module, require) {
        ...
        fun.delegateProp(DataTable.prototype, [ "data", "throttle", "debounce", "template", "formatter", "key", "selection", "selectedRows", "selectedRow", "selectedIndexes", "selectedIndex", "lastClickIndex", "multiselect", "setRowColStyle", "setRowStyle" ], "list");
            ...
            columns: function(cols) {
                if (cols) {
                    ...
                    for (var i = 0; this._columns.length > i; i++) {
                        var col = dom.createElement("col", {
                            "class": "uki-dataList-column"
                        });
